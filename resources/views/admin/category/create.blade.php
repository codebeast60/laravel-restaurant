...
<h1 class="text-center"><i class="fa-solid fa-staff-snake" style="color:red"></i> add new category</h1>
    ...
    <div class="container">
        <div class="panel panel-primary">
            ...
            <div class="panel-body">
                <div class="row">
                    <div class="col-md-8">
                        <form class="form-horizontal" autocomplete="off" action="/admin/category" method="POST"
                            ...
                            <div class="form-group form-group-lg">
                                ...
                                <div class="col-sm-10 col-md-9">
                                    <input pattern=".{4,}" title="this field require at least 4 characters" type="text"
                                        name="category_name" id="user" class="form-control" required>
                                </div>
                            </div>
                            <!--end name Field   -->
                            <!-- start item picture -->
                            ...
                            <div class=" form-group">
                                <div class="col-sm-offset-3 col-sm-9 mb-5">
                                    <input type="submit" value="+ Add category" class="btn btn-success w-50 btn-md">
                                </div>
                            </div>
                        </form>
                    </div>
